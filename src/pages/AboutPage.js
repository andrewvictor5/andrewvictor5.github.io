    ...
    return(
        <div>
            ...
            <Content>
                ...
                <p>At my second internship, I worked for Mentor Graphics as an AMS (Analog & Mixed-Signal) Intern. Due to the COVID-19 pandemic, I worked this internship entirely remote which was a new and different, yet very valuable experience for me. My main project involved converting PSpice models into Spice models that would be added to upcoming versions of Mentor's in-house software. This internship taught me the values of inner-team communication and how to be an efficient, independent worker. </p>
