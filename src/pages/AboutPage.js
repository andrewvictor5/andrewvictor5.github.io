...
function AboutPage(props) {
    ...
    return(
        <div>
            ...
            <Content>
                <p>My name is Andrew Victor and I am a recent graduate from Oregon State University with a Bachelor's Degree in Electrical & Computer Engineering with a Minor in Computer Science. </p>
